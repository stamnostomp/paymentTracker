...
var $author$project$Main$filterButtons = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value('both')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Show Both')
							])),
						A2(
						$elm$html$Html$option,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value('payments')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Show Payments')
							])),
						A2(
						$elm$html$Html$option,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value('expenses')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Show Expenses')
							]))
					]))
			]));
};
...
var $author$project$Main$total = function (model) {
	return A3(
		$elm$core$List$foldl,
		F2(
	...
	return model.showExpenseInputs ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Submit Expense')
					]))
			])) : $elm$html$Html$text('');
};
	...
	return model.showPaymentInputs ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Submit Payment')
					]))
			])) : $elm$html$Html$text('');
};
...
var $author$project$Main$viewStats = function (model) {
	var totalPayments = $elm$core$List$sum(
		A2(
			...
			model.payments));
	var target = 3500;
	var averageWeeklyPayment = ($elm$core$List$length(model.payments) > 0) ? (totalPayments / ($elm$core$List$length(model.payments) / 4)) : 0;
	var weeksNeeded = (averageWeeklyPayment > 0) ? ((target - totalPayments) / averageWeeklyPayment) : 0;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$elm$html$Html$text(
				'Total Payments: $' + $elm$core$String$fromFloat(totalPayments)),
				$elm$html$Html$text(
				'Average Weekly Payment: $' + $elm$core$String$fromFloat(averageWeeklyPayment)),
				$elm$html$Html$text(
				'Weeks Needed to Reach $' + ($elm$core$String$fromFloat(target) + (': ' + $elm$core$String$fromFloat(weeksNeeded)))),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Back to Main')
					]))
			]));
};
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Payments - Total: $' + $elm$core$String$fromFloat(
								$author$project$Main$total(model)))
						])),
					$elm$html$Html$text(
					'Total Payments This Month: $' + $elm$core$String$fromFloat(
						$author$project$Main$totalPaymentsThisMonth(model))),
					$author$project$Main$filterButtons(model),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Add Payment')
						])),
					$author$project$Main$viewPaymentInputs(model),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
					...
					$author$project$Main$viewExpenseInputs(model),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('View Stats')
						])),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
					$author$project$Main$viewFiltered(model))
				]));
	} else {
